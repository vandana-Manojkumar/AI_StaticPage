...
export default function SamAILanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden">
      ...
      {/* Main content */}
      <div className="relative z-10 container mx-auto px-6 py-6 sm:py-12">
        {/* Main heading - Reduced mobile spacing */}
        <div className="text-center mb-8 sm:mb-16">
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-3 sm:mb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent leading-tight">
            Power Your Presence with Intelligent
            <br />
            <span className="text-gray-800">Automation</span>
          </h1>
          ...
          {/* Subtitle */}
          <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-6 sm:mb-12 max-w-4xl mx-auto leading-relaxed">
            Join the waitlist and get exclusive early access to Sam AI. Shape the future of how creators manage their social presence.
          </p>
...
{/* Sam AI Section - Reduced mobile spacing */}        
<div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl py-6 sm:py-8 px-4 sm:px-6">   
  <div className="text-center">     
    ...
    <button       
      onClick={() => setShowForm(true)}       
      className="bg-black text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full text-base sm:text-lg font-medium hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl mb-2 sm:mb-4"     
    >       
      Get early access now! <span className="text-sm ml-2 hidden sm:inline">press Enter ↵</span>     
    </button>          
    
    {/* Social Address Logo - Reduced mobile size */}     
    <div className="flex items-center justify-center">       
      <img          
